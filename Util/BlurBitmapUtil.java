package com.example.cyb.dynamicblur.Util;
...
public class BlurBitmapUtil {
    ...
    public static void blur(Context context,View fromView, View toView, float radius,
                            float scaleFactor) {
        ...
        //overlay = blurBitmap(context,overlay,10);
