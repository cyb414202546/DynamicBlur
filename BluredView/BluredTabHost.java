...
public class BluredTabHost extends TabHost {
    Context context;
    ...
    public BluredTabHost(Context context) {
        super(context);
    }

    public BluredTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            if(getOnPreDrawListener() == null) {
                this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                    ...
                    public boolean onPreDraw() {
                        BlurBitmapUtil.blur
                                (context, BluredTabHost.this, getBackGroundView(),
        ...
        if(isBlur && backGroundView != null){
            if(getOnPreDrawListener() == null) {
                this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                    ...
                    public boolean onPreDraw() {
                        BlurBitmapUtil.blur
                                (context, getBackGroundView(), BluredTabHost.this,
                                        getBlurRadius(), getScale());
                        return true;
                    }
                };
