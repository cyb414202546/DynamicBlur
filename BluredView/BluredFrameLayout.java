...
public class BluredFrameLayout extends FrameLayout {
    ...
    public BluredFrameLayout(@NonNull Context context) {
        super(context);
    }

    public BluredFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BluredFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            if(getOnPreDrawListener() == null) {
                this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                    ...
                    public boolean onPreDraw() {
                        BlurBitmapUtil.blur
                                (context, BluredFrameLayout.this, getBackGroundView(),
        ...
        if(isBlur && backGroundView != null){
            if(getOnPreDrawListener() == null) {
                this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                    ...
                    public boolean onPreDraw() {
                        BlurBitmapUtil.blur
                                (context, getBackGroundView(), BluredFrameLayout.this,
                                        getBlurRadius(), getScale());
                        return true;
                    }
                };
